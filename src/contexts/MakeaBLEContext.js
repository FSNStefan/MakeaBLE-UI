    ...
    return (
        <MakeaBLEContext.Provider value={
            { 
                ...
                device_status: [device_status, setDeviceStatus], stateColor: [stateColor, setStateColor]
            }
        }>
            {props.children}
